...
#
#	\remarks	The cross3d.studiomax.Track module contains an
...
from cross3d import Clip, ClipPortion, TrackPortion
from cross3d.abstract.mixer.track import AbstractTrack
